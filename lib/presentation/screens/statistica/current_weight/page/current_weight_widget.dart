...
class CurrentWeighnWidget extends StatelessWidget {
  const CurrentWeighnWidget({super.key});

  @override
  Widget build(BuildContext context) {
    final bloc = context.read<CurrentWeightBloc>();
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          icon: Image.asset(
...
class _InputWeightWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bloc = context.watch<CurrentWeightBloc>();
