...
class MainNavigation {
  ...
  Map<String, WidgetBuilder> get routes => <String, WidgetBuilder>{
        ...
        Screen.addingCurrentWeight: (_) =>
            _screenFactory.addCurrentWeighnWidget(),
        Screen.infoPerfectWeightWidget: (_) => _screenFactory.infoSumWeight(),
        Screen.learnPerfectWeightWidget: (_) =>
            _screenFactory.learnPerfectWeightWidget(),
      };
  ...
  Route<Object>? onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Screen.addingFoodNew:
        final arguments = settings.arguments as AddNewFoodBloc;
        return MaterialPageRoute(
