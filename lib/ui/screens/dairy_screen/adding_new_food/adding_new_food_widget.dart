...
class AddingNewFoodWidget extends StatelessWidget {
  const AddingNewFoodWidget({Key? key}) : super(key: key);
...
class _SaveButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final model = context.watch<AddingNewFoodWidgetModel>();
...
class _AllOtherStaff extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final model = context.read<AddingNewFoodWidgetModel>();
    return Container(
