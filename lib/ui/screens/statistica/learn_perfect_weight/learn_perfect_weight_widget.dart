          ...
          Row(
            ...
            children: [
              _TextFieldWidget(
                helpText: 'Ege',
                onChanged: (text) =>
                    bloc.add(InputAgeLearnPerfectWeightEvent(textInput: text)),
              ),
          ...
          Row(
            ...
            children: [
              _TextFieldWidget(
                helpText: 'Growth',
                onChanged: (text) => bloc
                    .add(InputGrowthLearnPerfectWeightEvent(textInput: text)),
              ),
            ],
          ),
...
class _GenderButtonSelectWidget extends StatelessWidget {
  const _GenderButtonSelectWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    final bloc = context.watch<LearnPerfectWeightBloc>();
    ...
    return Container(
      ...
      child: ToggleButtons(
        ...
        onPressed: (int index) =>
            bloc.add(GenderSelectLearnPerfectWeightEvent(indexGender: index)),
